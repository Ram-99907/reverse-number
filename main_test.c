...
void test_reverse_negative_two_digit() {
    printf("Test: Reverse negative two digit (-42)... ");
    int result = reverse_number(-42);
    assert(result == -24);
    printf("PASSED\n");
}
...
void test_reverse_five_digit_number() {
    printf("Test: Reverse five digit number (12345)... ");
    int result = reverse_number(12345);
    assert(result == 54321);
    printf("PASSED\n");
}

void test_reverse_negative_palindrome() {
    printf("Test: Reverse negative palindrome (-121)... ");
    int result = reverse_number(-121);
    assert(result == -121);
    printf("PASSED\n");
}
...
int main() {
    ...
    test_reverse_negative_palindrome();
    tests_passed++;
